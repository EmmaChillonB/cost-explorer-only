...
import pytest
from cost_optimizer.cost_explorer.forecast import get_cost_forecast
...
def mock_ce_client():
    ...
    with patch(
        'cost_optimizer.cost_explorer.forecast.get_cost_explorer_client'
    ) as mock:
        client = MagicMock()
...
class TestCostForecast:
    ...
    async def test_get_cost_forecast_with_filter(self, mock_ce_client, future_date_range):
        ...
        with patch(
            'cost_optimizer.cost_explorer.forecast.validate_expression',
    ...
    @pytest.mark.asyncio
    @patch('cost_optimizer.cost_explorer.forecast.logger')
    ...
    @pytest.mark.asyncio
    @patch('cost_optimizer.cost_explorer.forecast.get_cost_explorer_client')
